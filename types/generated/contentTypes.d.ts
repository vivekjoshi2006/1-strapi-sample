...
export interface ApiMaggiRecipeMaggiRecipe extends Struct.CollectionTypeSchema {
  collectionName: 'maggi_recipes';
  info: {
    displayName: 'Maggi_Recipes';
    pluralName: 'maggi-recipes';
    singularName: 'maggi-recipe';
  };
  options: {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::maggi-recipe.maggi-recipe'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::maggi-recipe.maggi-recipe': ApiMaggiRecipeMaggiRecipe;
